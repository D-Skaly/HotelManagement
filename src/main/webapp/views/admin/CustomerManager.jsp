		...
		<div class="main" style="background-color: whitesmoke;">
			...
			<div class="tab-content mt-4">
				<div
					...
					id="user-list">
					<h3>Customer List</h3>
					<form class="d-flex mb-4" action="/admin/customermanager/" method="get">
						...
						<tbody>
							<c:forEach var="customer" items="${customers}">
								<tr>
									...
									<td>${customer.cccd}</td>
									<td><a
										href="/admin/customermanager/edit/${customer.userName}"
								...
								<td colspan="7">
									<div class="d-flex justify-content-center button-group">
										<button class="btn btn-secondary me-2"
											onclick="location.href='/admin/customermanager/?page=0&keyword=${keyword}&sortBy=${sortBy}&sortOrder=${sortOrder}'"
											${currentPage == 0 ? 'disabled' : ''}>First</button>
										<button class="btn btn-secondary me-2"
											onclick="location.href='/admin/customermanager/?page=${currentPage - 1}&keyword=${keyword}&sortBy=${sortBy}&sortOrder=${sortOrder}'"
											${currentPage == 0 ? 'disabled' : ''}>Previous</button>
										<button class="btn btn-secondary me-2"
											onclick="location.href='/admin/customermanager/?page=${currentPage + 1}&keyword=${keyword}&sortBy=${sortBy}&sortOrder=${sortOrder}'"
											${currentPage == totalPages - 1 ? 'disabled' : ''}>Next</button>
										<button class="btn btn-secondary"
											onclick="location.href='/admin/customermanager/?page=${totalPages - 1}&keyword=${keyword}&sortBy=${sortBy}&sortOrder=${sortOrder}'"
				...
				<div class="tab-pane fade ${activeTab == 'user-edition' ? 'show active' : ''}" id="user-edition">
                    <h3>Customer Edition</h3>
                    <form:form action="/admin/customermanager/update" method="post" modelAttribute="customer">
                        <div class="mb-3">
                            <label for="userName" class="form-label">Username</label>
                            <form:input type="text" path="userName" class="form-control" placeholder="Enter Username" readonly="readonly"/>
                        ...
                        <div class="mb-3">
                            ...
                            <form:input type="text" path="phone" class="form-control" placeholder="Enter Phone Numbers"/>
                        ...
                        <div class="mb-3">
                            ...
                            <form:input type="text" path="cccd" class="form-control" placeholder="Enter CCCD"/>
